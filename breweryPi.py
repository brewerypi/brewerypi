...
from app . models import Area, ElementAttributeTemplate, Element, ElementAttribute, ElementTemplate, Enterprise, EventFrame, EventFrameNote, EventFrameTemplate, Lookup, LookupValue, Note, Role, Site, Tag, TagValue, TagValueNote, UnitOfMeasurement, User
...
def make_shell_context():
	return dict(app = app, db = db, Area = Area, ElementAttributeTemplate = ElementAttributeTemplate, Element = Element, ElementAttribute = ElementAttribute,
