...
class EventFrameAttributeForm(FlaskForm):
	...
	eventFrameAttributeTemplate = QuerySelectField("Event Frame Attribute Template",
		query_factory = lambda: EventFrameAttributeTemplate.query.join(EventFrameTemplate, Site, Enterprise). \
		order_by(Enterprise.Abbreviation, Site.Abbreviation, ElementTemplate.Name, EventFrameTemplate.Name, EventFrameAttributeTemplate.Name), \
