...
from . forms import UploadTagsForm
# from .. import db
...
@builders.route("/builders/uploadTags", methods = ["GET", "POST"])
# @login_required
def uploadTags():
	form = UploadTagsForm()

	if form.validate_on_submit():
		flash (form.tags.data.read())

	return render_template("builders/uploadTags.html", form = form)
