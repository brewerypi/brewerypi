...
def eventFramesSummary(siteId = None, elementTemplateId = None, eventFrameTemplateId = None, months = None):
	...
	return render_template("dashes/eventFramesSummary/eventFramesSummary.html", activeOnly = activeOnly, earliestEventFrameId = earliestEventFrameId,
		elementTemplate = elementTemplate, eventFrameTemplate = eventFrameTemplate, months = months, site = site)
