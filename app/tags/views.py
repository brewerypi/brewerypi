...
def addTag(lookup = False):
	...
	if form.validate_on_submit():
		if lookup:
			tag = Tag(Area = form.area.data, Name = form.name.data, Description = form.description.data, Lookup = form.lookup.data)
		else:
	...
	return render_template("tags/tag.html", form = form, operation = operation)
...
def editTag(tagId):
	...
	return render_template("tags/tag.html", form = form, operation = operation, tag = tag)
