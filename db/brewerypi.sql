...
-- -----------------------------------------------------
-- Table `BreweryPi`.`EventFrameTemplate`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `BreweryPi`.`EventFrameTemplate` (
  `EventFrameTemplateId` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `Description` VARCHAR(255) NULL,
  `ElementTemplateId` INT UNSIGNED NOT NULL,
  `Name` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`EventFrameTemplateId`),
  UNIQUE INDEX `AK_EventFrameTemplate_ElementTemplateId_Name` (`ElementTemplateId` ASC, `Name` ASC),
  INDEX `FK__ElementTemplate$Has$EventFrameTemplate` (`ElementTemplateId` ASC),
  CONSTRAINT `FK__ElementTemplate$Has$EventFrameTemplate`
    FOREIGN KEY (`EventFrameTemplateId`)
    REFERENCES `BreweryPi`.`ElementTemplate` (`ElementTemplateId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
